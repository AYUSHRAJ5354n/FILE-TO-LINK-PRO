...
# 👑, Channels & Logs
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", '-1002625105380'))  # File storage channel
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", '-1002625105380'))  # General log channel
PREMIUM_LOGS = int(environ.get("PREMIUM_LOGS", '-1002625105380'))  # Premium user actions log
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1002625105380'))  # Verified user actions log
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1002625105380"))

# add admin IDs 11111 2222 3333 and add auth channel IDs -100XXX -100XXX -100XXX
ADMINS = list(map(int, environ.get('ADMINS', '1685470205').split()))  # List of admin user IDs
AUTH_CHANNEL = list(map(int, environ.get("AUTH_CHANNEL", "-1001962860571").split()))  # Allowed channels for authorization

# username add without @
OWNER_USERNAME = environ.get("OWNER_USERNAME", 'Explainer_AYU')  # Owner's username
BOT_USERNAME = environ.get("BOT_USERNAME", 'Moviespacin_bot')  # Bot's username

# 🔗 Channel & Support Links
CHANNEL = environ.get('CHANNEL', 'https://t.me/AYU_BOTS')  # Updates channel
SUPPORT = environ.get('SUPPORT', 'https://t.me/+S1AMHMx-PiM0ZGJl')  # Support group
...
DB_URL = environ.get('DATABASE_URI', "mongodb+srv://kentkouhwcsps:vNJdZFcCPyCShL2J@cluster0.rnjjo.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB connection URI
DB_NAME = environ.get('DATABASE_NAME', "Filetolink")  # MongoDB database name

# 📸 all Media (Images)
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/20rfrkxV/x.jpg')  # QR Code image
